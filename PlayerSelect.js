...
class PlayerSelScreen {
    ...
    drawPlayerSelScreen() {
        ...
        flipAnimation(0,85,65,100,140);
        flipAnimation(1,250,65,100,140);
        flipAnimation(2,415,65,100,140);
        flipAnimation(3,85,230,100,140);
        flipAnimation(4,250,230,100,140);
        flipAnimation(5,415,230,100,140);
        flipAnimation(6,250,395,100,140);
        /*push();
